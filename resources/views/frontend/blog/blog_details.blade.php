...
<div class="body-content">
	...
	<span class="date-time">{{ Carbon\Carbon::parse($blogpost->created_at)->diffForHumans()  }}</span>
                ...
                <div class="addthis_inline_share_toolbox_y6o4"></div>
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-60fbfb90f6248df2"></script>
