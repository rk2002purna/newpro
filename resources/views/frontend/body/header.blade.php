            ...
            <form method="post" action="{{ route('product.search') }}">
              ...
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html">Categories</a>
...
@if(session()->get('language') == 'hindi') {{ $subsubcategory->subsubcaty_name_hin }} @else {{ $subsubcategory->subsubcategory_name_en }} @endif
                  </a></li>egor
